...
Map<String, Category> moveEntries = {
  ...
  "Stride (L)": Category.jumps,
  "Stride (R)": Category.jumps,
  "Precision": Category.jumps,
  "Running Pre (L)": Category.jumps,
  "Running Pre (R)": Category.jumps,
  "Plyo": Category.jumps,
  "Safety Tap": Category.drops,
  "Ground Kong": Category.drops,
  "Gallop (L)": Category.drops,
  "Gallop (R)": Category.drops,
  "Kong Down": Category.drops,
  ...
  "Back Roll (L)": Category.drops,
"Back Roll (R)": Category.drops,
  "Dive Roll": Category.drops,
  "Wall Run (L)": Category.wall,
  "Wall Run (R)": Category.wall,
  "Cat Leap (L)": Category.wall,
  "Cat Leap (R)": Category.wall,
  "Climb Up (L)": Category.wall,
  "Climb Up (R)": Category.wall,
  "Top Out (L)": Category.wall,
  "Top Out (R)": Category.wall,
  "180 (L)": Category.wall,
  "180 (R)": Category.wall,
  "Tic-Tac (L)": Category.wall,
  "Tic-Tac (R)": Category.wall,
  "Pop Vault (L)": Category.wall,
  "Pop Vault (R)": Category.wall,
  "Lache": Category.bar,
  "Lache Regrab (L)": Category.bar,
  "Lache Regrab (R)": Category.bar,
  "Underbar (L)": Category.bar,
  "Underbar (R)": Category.bar,
  "Reverse Underbar (L)": Category.bar,
